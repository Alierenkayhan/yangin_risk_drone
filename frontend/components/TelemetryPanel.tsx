                ...
                <div className="bg-gradient-to-br from-emerald-900/20 to-slate-900/80 border border-emerald-500/30 rounded p-4 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[9px] text-emerald-500/70 font-mono">{OPEN_MODEL}</span>
                        </div>
                    </div>
                ...
                <div className="bg-gradient-to-br from-cyan-900/40 to-slate-900 border border-cyan-500/30 p-4 rounded relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <span className={`px-2 py-1 rounded text-[10px] font-bold border uppercase tracking-wider ${activeDrone.status === DroneStatus.PATROLLING || activeDrone.status === DroneStatus.FOLLOWING_PATH ? 'bg-green-500/20 border-green-500 text-green-400' :
